...
function (_) {
    ...
    var Package = Base.extend({
        constructor: function (d, e) {
            ...
            var f = /[^\s,]+/g;
            if (d) {
                d.imports = Array2.reduce(this.imports.match(f),
                function (a, b) {
                    eval("var ns=base2." + b);
                ...
                d.exports = Array2.reduce(this.exports.match(f),
                function (a, b) {
                    var c = this.name + "." + b;
    ...
    var JavaScript = {
        ...
        namespace: "",
        bind: function (c) {
            forEach(this.exports.match(/\w+/g),
            function (a) {
                var b = a.slice(0, -1);
                extend(c[b], this[a]);
...
function (_) {
    ...
    extend(Element.prototype, "cloneNode",
    function (a) {
    ...
    var DOMContentLoadedEvent = Base.extend({
        constructor: function (b) {
            ...
            EventTarget.addEventListener(b, "DOMContentLoaded",
            function () {
                c = true
            },
            false);
    ...
    extend(NodeSelector.prototype, {
        ...
        querySelectorAll: function (b) {
            return extend(this.base(b), "item",
            function (a) {
                return DOM.bind(this.base(a))
            })
        }
    ...
    var CSSParser = RegGrp.extend({
        ...
        escape: function (b) {
            var c = /'/g;
            var d = this._46 = [];
            return this.optimise(this.format(String(b).replace(CSSParser.ESCAPE,
            function (a) {
    ...
    var HTMLDocument = Document.extend(null, {
        "@(document.activeElement===undefined)": {
            bind: function (b) {
                ...
                EventTarget.addEventListener(b, "focus",
                function (a) {
...
function (_) {
    ...
    },
    {
        ...
        init: function () {
            EventTarget.addEventListener(document, "DOMContentLoaded",
            function () {
                if (Call.list) {
                    DOM.bind(document);
...
var Colorizer = RegGrp.extend({
    ...
    _67: function (c) {
        ...
        if (d > 0) {
            ...
            return c.replace(Colorizer.TABS,
            function (a) {
    ...
    _shrinkVariables: function (script) {
        ...
        var decode = function (script) {
            while (ENCODED.test(script)) {
                script = script.replace(global(ENCODED),
...
var JsCompress = function (script, base62, shrink) {
    //var pack = new Packer();
    //return pack.pack(script, base62, shrink);
    return "aabbb";
}

//public class JsCompressScript
//{
//public static JsCompress( script,  base62,  shrink)
//{
//    var pack = new Packer();
//    return pack.pack(script, base62, shrink);
//}
